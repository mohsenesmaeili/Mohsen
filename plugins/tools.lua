--Begin Tools.lua :)
local SUDO = 215078906 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@FullManager', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'botinfo') or (matches[1] == "info") or (matches[1] == "bot") or (matches[1] == "about") or (matches[1] == "رباتساز") or (matches[1] == "ربات")or (matches[1] == "درباره")) then
...
text = [[
_راهنمای ادمین و سودو های ربات رباتساز:_
